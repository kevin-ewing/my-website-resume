        ...
        <Dialog open={alertShow} onClose={handleAlertClose} aria-labelledby="simple-dialog-title" style={{ zIndex: 1500 }} className={classes.root}>
            <CardContent>
                ...
                <Typography variant="body2" component="p">
                    I am always learning. Wheather that be through school, work, or projects I am continuously pushing myself 
                    to learn new things, expirement and push myself. Some examples of my learning are on this page. Take a look 
                    at the projects marked as done.
                    <br />
                </Typography>
            </CardContent>
            <CardActions>
