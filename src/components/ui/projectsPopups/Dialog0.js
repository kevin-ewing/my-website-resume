        ...
        <Dialog open={alertShow} onClose={handleAlertClose} aria-labelledby="simple-dialog-title" style={{ zIndex: 1500 }} className={classes.root}>
            <CardContent>
                ...
                <Typography variant="body2" component="p">
                    This interface was inspired by Jira. Each ticke represents a small project that I have undertaken,
                    with a small blurb of infomration about that project. To learn more about a project select that
                    ticket just as you would in Jira.
                    <br />
                </Typography>
            </CardContent>
            <CardActions>
